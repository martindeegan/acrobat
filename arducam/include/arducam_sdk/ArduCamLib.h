...
unsigned int
    ArduCam_writeReg_8_8(ArduCamHandle useHandle, Uint32 shipAddr, Uint32 regAddr, Uint32 val);
unsigned int
    ArduCam_readReg_8_8(ArduCamHandle useHandle, Uint32 shipAddr, Uint32 regAddr, Uint32* pval);
unsigned int
    ArduCam_writeReg_8_16(ArduCamHandle useHandle, Uint32 shipAddr, Uint32 regAddr, Uint32 val);
unsigned int
    ArduCam_readReg_8_16(ArduCamHandle useHandle, Uint32 shipAddr, Uint32 regAddr, Uint32* pval);
unsigned int
    ArduCam_writeReg_16_8(ArduCamHandle useHandle, Uint32 shipAddr, Uint32 regAddr, Uint32 val);
unsigned int
    ArduCam_readReg_16_8(ArduCamHandle useHandle, Uint32 shipAddr, Uint32 regAddr, Uint32* pval);
unsigned int
    ArduCam_writeReg_16_16(ArduCamHandle useHandle, Uint32 shipAddr, Uint32 regAddr, Uint32 val);
unsigned int
             ArduCam_readReg_16_16(ArduCamHandle useHandle, Uint32 shipAddr, Uint32 regAddr, Uint32* pval);
void         ArduCam_enableForceRead(ArduCamHandle useHandle);
void         ArduCam_disableForceRead(ArduCamHandle useHandle);
unsigned int ArduCam_setboardConfig(ArduCamHandle useHandle,
                                    Uint8         u8Command,
                                    Uint16        u16Value,
                                    Uint16        u16Index,
                                    Uint32        u32BufSize,
                                    Uint8*        pu8Buf);
unsigned int ArduCam_getboardConfig(ArduCamHandle useHandle,
                                    Uint8         u8Command,
                                    Uint16        u16Value,
                                    Uint16        u16Index,
                                    Uint32        u32BufSize,
                                    Uint8*        pu8Buf);
unsigned int
    ArduCam_readUserData(ArduCamHandle useHandle, Uint16 u16Addr, Uint8 u8Len, Uint8* pu8Data);
unsigned int
             ArduCam_writeUserData(ArduCamHandle useHandle, Uint16 u16Addr, Uint8 u8Len, Uint8* pu8Data);
unsigned int ArduCam_softTrigger(ArduCamHandle useHandle);
unsigned int ArduCam_isFrameReady(ArduCamHandle useHandle);
unsigned int ArduCam_getSingleFrame(ArduCamHandle    useHandle,
                                    ArduCamOutData*& pstFrameData,
                                    int              time_out = 1500);
